...
<div style="margin-top: -25px" class="py-5 hero overlay inner-page bg-primary">
    <div class="container">
        <div class="pt-5 text-center row align-items-center justify-content-center">
            <div class="col-lg-6">
                <h1 class="mb-3 text-white heading" data-aos="fade-up">Contact Us</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="mb-5 col-lg-4 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
